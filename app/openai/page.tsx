 ...
 * - Unified card design: rounded-lg border border-gray-200 shadow-lg bg-white p-8
                ...
                <div className="rounded-lg border border-gray-200 mb-4">
                  ...
                  {openA && (
                    <div className="px-4 pb-4 space-y-4">
                      ...
                      {/* URL Input */}
                      <div>
                        <label className="block text-xs font-normal text-gray-700 mb-2">URL Content</label>
                        <input
                          type="url"
                      ...
                      {/* Text Paste */}
                      <div>
                        <label className="block text-xs font-normal text-gray-700 mb-2">Paste Text</label>
                        <textarea
                      ...
                      <div className="mb-4">
                        <button
                          ...
                          className="w-full rounded-lg border border-purple-200 bg-purple-50 text-purple-700 hover:bg-purple-100 px-4 py-2 text-center transition-all duration-200 h-9 flex items-center justify-center"
                        >
                      ...
                      <div className="mb-4">
                        <button
                          ...
                          className={`w-full rounded-lg border px-4 py-2 text-center transition-all duration-200 h-9 flex items-center justify-center ${
                      ...
                      <div className="flex gap-3">
                        <button
                          ...
                          className="flex-1 rounded-lg border border-gray-200 px-4 py-2 text-center hover:bg-gray-50 transition-colors duration-200 h-9 flex items-center justify-center"
                        >
                          <span className="text-xs">View</span>
                        </button>
                        <button
                          onClick={resetDataSection}
                          className={`flex-1 rounded-lg border px-4 py-2 text-xs font-normal transition-all duration-200 h-9 flex items-center justify-center ${
                            dataReset 
                      ...
                      <div className="mt-4">
                        <button
                          ...
                          className="w-full rounded-lg border border-orange-200 bg-orange-50 text-orange-700 hover:bg-orange-100 px-4 py-2 text-center transition-all duration-200 h-9 flex items-center justify-center"
                        >
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8 shadow-lg h-full">
                  ...
                  {(apiResult || errorMsg) && (
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 rounded-lg border border-blue-200 bg-blue-50 text-blue-700 hover:bg-blue-100 transition-colors duration-200 text-xs"
                      >
                        Copy
                      </button>
                      <button
                        onClick={clearResponse}
                        className="px-3 py-1.5 rounded-lg border border-red-200 bg-red-50 text-red-700 hover:bg-red-100 transition-colors duration-200 text-xs"
                      >
                        Clear
                      </button>
                    </div>
                ...
                {errorMsg && (
                  <div className="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg">
                    <h3 className="text-sm font-normal text-red-800 mb-2">Error</h3>
                    ...
                    {structuredMode && isValidJson && (
                      <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm text-green-700 font-normal">Valid JSON Response</span>
                        </div>
                      </div>
                    )}
